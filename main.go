...
var routerCollection = []Router{
	{ID: 101, Name: "KZ Backbone One", ModelName: "Juniper PTX10008", Description: "Центральный маршрутизатор ядра провайдера для магистрального узла.", Status: StatusPublished, ImageKey: "routers/core.svg", VideoKey: "videos/core-loop.mp4", RouterType: "central", ThroughputMbps: 100000, PowerConsumptionW: 1450, PortCount: 8, Location: "ЦОД Астана, стойка A-12", MasterRouterName: "—", LikedUserIDs: []int{2, 7, 13, 21}},
	{ID: 102, Name: "North Ring Hub", ModelName: "Cisco NCS 540", Description: "Промежуточный маршрутизатор северного кольца с агрегацией районных узлов.", Status: StatusPublished, ImageKey: "routers/ring.svg", VideoKey: "videos/ring-loop.mp4", RouterType: "intermediate", ThroughputMbps: 10000, PowerConsumptionW: 310, PortCount: 24, Location: "Астана, Северный узел", MasterRouterName: "KZ Backbone One", LikedUserIDs: []int{4, 8, 15}},
	{ID: 103, Name: "Turan Residence Gateway", ModelName: "MikroTik CCR2116", Description: "Конечный маршрутизатор жилого комплекса: распределение трафика квартир.", Status: StatusPublished, ImageKey: "routers/residential.svg", VideoKey: "videos/residential-loop.mp4", RouterType: "residential", ThroughputMbps: 1000, PowerConsumptionW: 72, PortCount: 16, Location: "ЖК Туран, корпус 3", MasterRouterName: "North Ring Hub", LikedUserIDs: []int{1, 3, 6, 9, 12, 18}},
	{ID: 104, Name: "Saryarka Residence Gateway", ModelName: "MikroTik CCR2004", Description: "Черновик карточки маршрутизатора для следующего жилого дома.", Status: StatusDraft, ImageKey: "routers/draft.svg", VideoKey: "videos/draft-loop.mp4", RouterType: "residential", ThroughputMbps: 1000, PowerConsumptionW: 48, PortCount: 12, Location: "ЖК Сарыарка, корпус 1", MasterRouterName: "North Ring Hub", LikedUserIDs: []int{5}},
	{ID: 105, Name: "Legacy South Edge", ModelName: "Cisco ASR 920", Description: "Выведенный из эксплуатации пограничный маршрутизатор.", Status: StatusDeleted, ImageKey: "routers/legacy.svg", VideoKey: "videos/legacy-loop.mp4", RouterType: "intermediate", ThroughputMbps: 1000, PowerConsumptionW: 210, PortCount: 8, Location: "Астана, Южный узел", MasterRouterName: "KZ Backbone One", LikedUserIDs: []int{11}},
}
