...
var providerRouters = []ProviderRouter{
	{ID: 101, Name: "Core Backbone One", Description: "Центральный маршрутизатор ядра провайдера для магистрального узла и распределения трафика между городскими сегментами сети.", Status: statusPublished, ImageKey: "routers/core.svg", VideoKey: "videos/core-loop.mp4", RouterType: "central", BandwidthMbps: 100000, CostRub: 980000, LikedUserIDs: []int{2, 7, 13, 21}},
	{ID: 102, Name: "North Ring Hub", Description: "Промежуточный маршрутизатор кольцевой сети, который агрегирует районные узлы и передаёт трафик на магистраль.", Status: statusPublished, ImageKey: "routers/ring.svg", VideoKey: "videos/ring-loop.mp4", RouterType: "intermediate", BandwidthMbps: 10000, CostRub: 310000, LikedUserIDs: []int{4, 8, 15}},
	{ID: 103, Name: "Harbor Residence Gateway", Description: "Конечный маршрутизатор жилого комплекса для распределения доступа к сети между квартирами.", Status: statusPublished, ImageKey: "routers/residential.svg", VideoKey: "videos/residential-loop.mp4", RouterType: "residential", BandwidthMbps: 1000, CostRub: 72000, LikedUserIDs: []int{1, 3, 6, 9, 12, 18}},
	{ID: 104, Name: "Riverside Residence Gateway", Description: "Черновик карточки маршрутизатора для следующего жилого дома.", Status: statusDraft, ImageKey: "routers/draft.svg", VideoKey: "videos/draft-loop.mp4", RouterType: "residential", BandwidthMbps: 1000, CostRub: 65000, LikedUserIDs: []int{5}},
	{ID: 105, Name: "Legacy South Edge", Description: "Выведенный из эксплуатации пограничный маршрутизатор.", Status: statusDeleted, ImageKey: "routers/ring.svg", VideoKey: "videos/ring-loop.mp4", RouterType: "intermediate", BandwidthMbps: 1000, CostRub: 50000, LikedUserIDs: []int{11}},
}
